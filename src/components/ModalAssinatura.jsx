...
import { FaSignature, FaUpload, FaSpinner } from 'react-icons/fa';
        ...
        <div className="p-6">
          <div className="mb-6">
            <p className="text-slate-700 leading-relaxed">
              {hasCertificate 
                ? "Você possui um certificado digital ativo. Como deseja assinar este laudo?"
                : "Você não possui um certificado digital ativo. Para finalizar o laudo, faça upload do arquivo assinado."
              }
            </p>
          </div>
