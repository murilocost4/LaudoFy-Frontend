        ...
        <div className="bg-white p-8 rounded-2xl shadow-lg border border-slate-200">
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              onClick={() => navigate("/")}
              className="inline-flex items-center text-sm text-slate-600 hover:text-slate-800 font-medium transition-colors underline-offset-2 hover:underline"
            >
          ...
          >
            ...
            <p className="text-xs text-slate-400 mt-2">
              © {new Date().getFullYear()} Fytenza • Todos os direitos reservados
            </p>
          </motion.div>
        </div>
      </motion.div>
