...
const TableRow = memo(
  ({
    ...
    return (
      <>
        <tr
          className={`hover:bg-slate-50 transition-colors duration-150 ${isSelected ? "bg-slate-50" : index % 2 === 0 ? "bg-white" : "bg-slate-25"}`}
        >
          ...
          <td className="px-4 py-3 whitespace-nowrap">
            <div className="flex items-center">
              <div className="h-8 w-8 rounded-full bg-gradient-to-r from-slate-600 to-slate-700 flex items-center justify-center">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                <div className="bg-white rounded-lg p-3 shadow-sm border border-slate-200">
                  <h4 className="text-base font-semibold text-slate-900 mb-3 flex items-center">
                    <FiInfo className="h-4 w-4 mr-2 text-slate-500" />
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    {pagamento.observacoes && (
                      <div>
                        ...
                        <p className="text-slate-900 bg-slate-100 p-2 rounded mt-1">
                          {pagamento.observacoes}
                        </p>
                      </div>
                    )}
...
const PaymentCard = memo(
  ({
    ...
    return (
      <div className="bg-white rounded-xl shadow-md border border-slate-100 hover:shadow-lg transition-shadow duration-200 overflow-hidden">
        <div className="p-4">
          ...
          <div className="space-y-2 mb-4">
            <div className="flex justify-between items-center">
              <span className="text-sm text-slate-600">Valor Final:</span>
            ...
            <div className="flex justify-between items-center">
              <span className="text-sm text-slate-600">Laudos:</span>
              <span className="bg-slate-100 text-slate-800 px-2 py-1 rounded-full text-xs font-medium">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={onExpand}
              className="flex items-center space-x-2 px-3 py-2 bg-slate-100 text-slate-700 rounded-lg hover:bg-slate-200 transition-colors duration-150 text-sm font-medium"
            >
          ...
          <div className="border-t border-slate-100 bg-slate-50 p-4">
            <div className="space-y-3 text-sm">
              <div>
                ...
                <p className="text-xs text-slate-600 font-mono bg-white p-2 rounded border mt-1">
                  {pagamento._id}
                </p>
              </div>
              {pagamento.observacoes && (
                <div>
                  ...
                  <p className="text-slate-600 bg-white p-2 rounded border mt-1">
                    {pagamento.observacoes}
                  </p>
                </div>
              )}
  ...
  return (
    <div className="min-h-screen bg-slate-100">
      <div className="container mx-auto px-4 py-6">
        {/* Header */}
        <div className="bg-gradient-to-r from-slate-50 to-slate-100 rounded-2xl p-6 shadow-md border border-white/50 mb-6">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
            ...
            <div className="flex items-center space-x-3">
              ...
              <button
                ...
                disabled={loading}
                className="flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-slate-600 to-slate-700 hover:from-slate-700 hover:to-slate-800 text-white rounded-lg font-medium transition-all duration-200 shadow-md disabled:opacity-70"
              >
                <FiRefreshCw
          ...
          {loading ? (
            ...
            <div className="p-16 text-center">
              <div className="flex flex-col items-center space-y-4">
                <div className="p-4 bg-gradient-to-r from-slate-100 to-slate-200 rounded-full">
                  <FiBarChart className="h-16 w-16 text-slate-400" />
                </div>
                <div>
                ...
                {hasActiveFilters && (
                  <button
                    onClick={limparFiltros}
                    className="flex items-center space-x-2 px-4 py-2 bg-slate-500 text-white rounded-lg font-medium shadow-md hover:bg-slate-600 transition-colors duration-200"
                  >
                    <FiX className="h-4 w-4" />
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    {selectedPayments.length > 0 && (
                      <button
                        ...
                        className="flex items-center space-x-2 px-3 py-1 bg-slate-100 text-slate-700 rounded-lg hover:bg-slate-200 transition-colors text-sm font-medium"
                      >
                        <FiDownload className="h-4 w-4" />
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      <button
                        ...
                        className="px-3 py-1 text-sm font-medium text-slate-500 bg-white border border-slate-300 rounded hover:bg-slate-50 disabled:opacity-50"
                      >
                        Anterior
                      </button>
